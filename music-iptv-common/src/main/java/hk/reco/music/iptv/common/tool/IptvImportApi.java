...
public class IptvImportApi {
    ...
    static {
        singerCategorys.put("t4,0", IptvResVer.createCategory(IptvObjectEnum.singer, "内地男歌手", "t4,0", "d:/singer-category/内地男歌手.png",1f));
        singerCategorys.put("t4,1", IptvResVer.createCategory(IptvObjectEnum.singer, "内地女歌手", "t4,1", "d:/singer-category/内地女歌手.png", 2f));
        singerCategorys.put("t4,2", IptvResVer.createCategory(IptvObjectEnum.singer, "内地组合", "t4,2", "d:/singer-category/内地组合.png", 3f));
        singerCategorys.put("t5,0", IptvResVer.createCategory(IptvObjectEnum.singer, "港台男歌手", "t5,0", "d:/singer-category/港台男歌手.png", 4f));
        singerCategorys.put("t5,1", IptvResVer.createCategory(IptvObjectEnum.singer, "港台女歌手", "t5,1", "d:/singer-category/港台女歌手.png", 5f));
        singerCategorys.put("t5,2", IptvResVer.createCategory(IptvObjectEnum.singer, "港台组合", "t5,2", "d:/singer-category/港台组合.png", 6f));
        singerCategorys.put("t6,0", IptvResVer.createCategory(IptvObjectEnum.singer, "韩国男歌手", "t6,0", "d:/singer-category/韩国男歌手.png", 7f));
        singerCategorys.put("t6,1", IptvResVer.createCategory(IptvObjectEnum.singer, "韩国女歌手", "t6,1", "d:/singer-category/韩国女歌手.png",8f));
        singerCategorys.put("t6,2", IptvResVer.createCategory(IptvObjectEnum.singer, "韩国组合", "t6,2", "d:/singer-category/韩国组合.png", 9f));
        singerCategorys.put("t7,0", IptvResVer.createCategory(IptvObjectEnum.singer, "日本男歌手", "t7,0", "d:/singer-category/日本男歌手.png", 10f));
        singerCategorys.put("t7,1", IptvResVer.createCategory(IptvObjectEnum.singer, "日本女歌手", "t7,1", "d:/singer-category/日本女歌手.png",11f));
        singerCategorys.put("t7,2", IptvResVer.createCategory(IptvObjectEnum.singer, "日本组合", "t7,2", "d:/singer-category/日本组合.png", 12f));
        singerCategorys.put("t8,0", IptvResVer.createCategory(IptvObjectEnum.singer, "欧美男歌手", "t8,0", "d:/singer-category/欧美男歌手.png",13f));
        singerCategorys.put("t8,1", IptvResVer.createCategory(IptvObjectEnum.singer, "欧美女歌手", "t8,1", "d:/singer-category/欧美女歌手.png", 14f));
        singerCategorys.put("t8,2", IptvResVer.createCategory(IptvObjectEnum.singer, "欧美组合", "t8,2", "d:/singer-category/欧美组合.png",15f));
    }
