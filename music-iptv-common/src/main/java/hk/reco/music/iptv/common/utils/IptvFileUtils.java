...
public class IptvFileUtils {
     ...
     * @param httpPrefix
     */
    public static void initFileEnv(String root, String httpPrefix, boolean iptvCodePrefix, Integer port) {
        IptvFileUtils.root = root;
        IptvFileUtils.httpPrefix = httpPrefix;
        IptvFileUtils.iptvCodePrefix = iptvCodePrefix;
        IptvFileUtils.port = port;
    }
...
//			if(islocal){
            ...
            SshTransfer.transfer(ip, username, password, port, is, path);
//			}else{
