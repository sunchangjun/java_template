...
public class IptvConsoleResService{
	...
	private IptvPriceService priceService;
	@Autowired
	...
	private void recurisiveLayout(IptvResVer parent, int nowdeep, int maxdeep, boolean showLeaf){
	...
	public void consoleReschangefreeStatus(Long rid,Integer free) throws Exception{
		if(priceService!=null){
			 ...
			 priceService.setFree(rid, isfree);
		 }
